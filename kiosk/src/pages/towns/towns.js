      ...
      return townarray.map(item=>{
        ...
        return (
          ...
          <div className = "card-body">
            ...
            <h6>{boldtext}</h6>
            <p>{text}</p>
            <p>This is a placeholder for the QR component</p>
